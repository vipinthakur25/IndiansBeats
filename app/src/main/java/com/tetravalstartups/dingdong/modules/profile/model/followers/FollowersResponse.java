...
public class FollowersResponse {
    ...
    public FollowersResponse(String id, String handle, String name, String email, Integer likes, Integer following, Integer followers, Integer videos, String bio, String photo, String timestamp, String myfollow) {
        this.id = id;
        this.handle = handle;
        this.name = name;
        this.email = email;
