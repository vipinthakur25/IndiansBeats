...
public class MostViewVideoResponse {
     ...
     * @param mylike
     */
    public MostViewVideoResponse(String id, String soundId, String soundTitle, Integer likesCount, Integer shareCount, Integer commentCount, Integer viewCount, String userId, String videoUrl, String videoThumbnail, Integer videoStatus, String videoIndex, String videoDesc, String timestamp, String userHandle, String userName, String userPhoto, Integer mylike, String myfollow) {
        super();
        this.id = id;
