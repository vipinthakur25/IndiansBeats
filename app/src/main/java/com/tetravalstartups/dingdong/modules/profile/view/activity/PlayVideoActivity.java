                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (queryDocumentSnapshots.getDocuments().isEmpty()){
                            ...
                            videoAdapter = new VideoAdapter(PlayVideoActivity.this, privateDraftVideosList);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()){
                            if (task.getResult().getDocuments().isEmpty()){
                                Toast.makeText(PlayVideoActivity.this, "No Videos", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                videoAdapter = new VideoAdapter(PlayVideoActivity.this, videoList);
                                videoAdapter.notifyDataSetChanged();
                                SnapHelper snapHelper = new PagerSnapHelper();
                                recyclerVideos.setLayoutManager(new LinearLayoutManager(PlayVideoActivity.this));
                                recyclerVideos.scrollToPosition(pos);
