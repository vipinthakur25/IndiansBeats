...
public class TaggedVideosResponse {
     ...
     * @param mylike
     */
    public TaggedVideosResponse(String id, String soundId, String soundTitle, Integer likesCount, Integer shareCount, Integer commentCount, Integer viewCount, String userId, String videoUrl, String videoThumbnail, Integer videoStatus, String videoIndex, String videoDesc, String timestamp, String myfollow, Integer mylike) {
        super();
        this.id = id;
