...
public class AvailableTaskResponse {
     ...
     * @param status
     */
    public AvailableTaskResponse(String id, String name, Integer totalUploads, Integer avlUploads, String startDate, String endDate, Integer monthlyProfit, Integer status, Integer planId, String userId, String transectionId) {
        super();
        this.id = id;
        this.name = name;
